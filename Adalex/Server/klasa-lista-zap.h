...
//---------------------------------------------------------------------------
struct wezel{
  zapotrzebowanie_jedno *poprzedni;
  zapotrzebowanie_jedno *nastepny;
  zapotrzebowanie_jedno *wybrany;
}
class lista_zap
{
//----------------
 ...
 public:
  ...
  lista_zap(){
    ilosc_polecen=0;
    pierwszyW.poprzedni=NULL;
    pierwszyW.nastepny=NULL;
    pierwszyW.wybrany=NULL;
    ostatniW.poprzedni=NULL;
    ostatniW.nastepny=NULL;
    ostatniW.wybrany=NULL;
    wybranyW.poprzedni=NULL;
    wybranyW.nastepny=NULL;
    wybranyW.wybrany=NULL;
  }
